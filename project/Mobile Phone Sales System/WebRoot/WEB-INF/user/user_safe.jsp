...
<script type="text/javascript">
    ...
    function onmouseover1( ){
     ...
     function queding(){
    	 ...
    	 if(againpassword==""){
    		 flag=false;
    		 $("#againpassword_error").text("*密码不能为空！"); 
    	 }else{
    		 $("#againpassword_error").text("");  
    	 }
    	 if(newtelephone==""){
    		 flag=false;
    		 $("#newtelephone_error").text("*手机号不能为空！");  
    	 }else{
    		 $("#newtelephone_error").text("");  
    	 }
    	 if(newpassword!=againpassword){
    		 flag=false;
    		  $("#againpassword_error").text("*两次密码不一致！"); 
    	 }else{
    		 $("#againpassword_error").text("");
    	 }
    	  if(!telephone.test(newtelephone)){
            $("#newtelephone_error").text("*电话格式不对！");
                 flag=false;
              }
  ...
  <div class="main" >
    ...
    <div style="border:1px solid #c5c5c5;float:left;width:800px;background:white;height:600px;">
        <div style="width:100%;border-top:1px solid #c5c5c5;border-bottom:1px dashed #c5c5c5;margin-top:50px;padding-top:5px;padding-bottom:5px;">
            <span style="font-size:14px;margin-left:40px;">安全设置</span>
        </div>
        
        <form action="" method="post" id="form1">
            <div style="width:80%;border-bottom:1px solid #c5c5c5;margin:30px auto;padding-top:5px;padding-bottom:5px;">
              <span style="font-size:14px;margin-left:40px;">修改密码</span>
            </div>
            <table style="margin:0 auto;border-spacing: 15px;">
                <tr>
                   ...
                   <td>
                      <input type="password" value="${safeuser.userpassword}" disabled="disabled"/>
                   </td>
                </tr>
                ...
                <tr>
                   ...
                   <td>
                      <input type="hidden" value="${safeuser.user_id}" name="user_id">
                ...
                <tr>
                   ...
                   <td>
                      <span id="againpassword_error" style="color: red;"></span>
                   </td>
                </tr>
            </table>
            
            <div style="width:80%;border-bottom:1px solid #c5c5c5;margin:30px auto;padding-top:5px;padding-bottom:5px;">
              <span style="font-size:14px;margin-left:40px;">修改手机号</span>
            </div>
            <table style="margin:0 auto;border-spacing: 15px;">
                <tr>
                   <td>
                   ...
                   <td>
                      <input type="text" value="${safeuser.telephone}" disabled="disabled"/>
                   </td>
                </tr>
                ...
                <tr>
                   ...
                   <td>
                      <input type="password" name="newtelephone" id="newtelephone"/>
                   </td>
                   <td>
                       <span id="newtelephone_error" style="color: red;"></span>
                   </td>
                </tr>
                <tr >
