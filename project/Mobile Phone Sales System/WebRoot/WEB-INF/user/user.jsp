     ...
     function tijiao(){
              ...
              if(username==""){
                 ...
                 flag=false;
            	   ...
            	   $("#username_error").text("*填写真实的资料，有助于收货时方便取货！");
              }
              if(realname==""){
                 $("#realname_error").text("*真实姓名不能为空！");
                 flag=false;
              }
              else{
            	   $("#realname_error").text("*请如实填写方便退货时校验！");
              }
              if(email=="")
              {
                  $("#email_error").text("*电子邮箱不能为空！");
                  flag=false;
              }
              else{ 
            	   $("#email_error").text("* 请填写正确的邮箱地址！");
              }
              if(!flag){
                 return ;
              }
  ...
  <div class="main" >
    ...
    <div style="border:1px solid #c5c5c5;float:left;width:800px;background:white;height:600px;">
        <div style="width:100%;border-top:1px solid #c5c5c5;border-bottom:1px dashed #c5c5c5;margin-top:50px;padding-top:5px;padding-bottom:5px;">
            <span style="font-size:14px;margin-left:40px;">个人资料</span>
        </div>
        <form action="" method="post" id="tijiaoform">
             <table style="margin:0 auto; border-spacing: 30px;">
                <tr>
                   ...
                   <td>
                   <input type="hidden" name="user_id" value="${usercenter.user_id}"/>
                       <input type="text" name="username" id="username" value="${usercenter.username}"/>
                   </td>
                   <td>
                      <span id="username_error" style="color: red;">*填写真实的资料，有助于收货时方便取货!</span>
                   </td>
                </tr>
                <tr>
                   <td>
                   ...
                   <td>
                      <input type="text" name="telephone" id="telephone" value="18251815342" disabled="disabled"/>
                   </td>
                ...
                <tr>
                   ...
                   <td>
                      <input type="text" name="realname" id="realname" value="${usercenter.realname}" />
                   </td>
                   <td>
                      <span id="realname_error" style="color: red;">*请如实填写方便退货时校验!</span>
                   </td>
                </tr>
                <tr>
                   <td>
                ...
                <tr>
                   ...
                   <td>
                     <input type="text" name="address" id="address" value="${usercenter.address}" size="30"  disabled="disabled"/>
                   </td>
                ...
                <tr>
                   ...
                   <td>
                      <input type="text" name="email" id="email" value="${usercenter.email}"/>
                   </td>
                    <td>
                      <span id="email_error" style="color: red;">*请填写正确的邮箱地址！</span>
                   </td>
                </tr>
                 <tr>
                   <td>
                   ...
                   <td>
                      <input type="password" name="password" value="${usercenter.userpassword}" disabled="disabled" size="10"/>      
                   </td>
                </tr>
                <tr>
                   <td align="center" colspan="2">
                       <a href="javascript:tijiao();"><img src="../images/button_14.png" /></a>
                   </td>
                </tr>
             </table>
        </form>
